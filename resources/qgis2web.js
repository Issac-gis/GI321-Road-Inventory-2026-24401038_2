...
map.getView().fit([16441533.479279, -736905.902493, 16446187.654543, -734196.650862], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Rural Road Inventory Web Mapping - GI 321 - 24401038</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (556 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This educational Web GIS presents selected rural-road inventory layers for learning about road alignment, gradient and slope, drainage assets, culvert condition, inundation risk and interactive web mapping. It supports exploration and teaching; it is not an official engineering asset register and must not be used as the sole basis for construction, maintenance or public-safety decisions.<br /><br />Authoritative source as Practical_Assignment_1_Data_26072026.gpkg.<br />Working data as GI321_WebReady_24401038.gpkg.<br />Working CRS as EPSG:32755 - WGS 84 / UTM Zone 55S. ';
            }
